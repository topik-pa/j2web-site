...
$UrlYT= $_POST["UrlYT"];
$PrezzoConcessionari= $_POST["PrezzoConcessionari"];
$condividiveicolo= $_POST["condividiveicolo"];
...
$sql = "INSERT INTO autoveicoli ( idutente, Marca, Modello, Versione, Descrizione, 
			...
			Immagine10, UrlYT, condividiveicolo, PrezzoConcessionari) 
			...
			'".$foto8."', '".$foto9."', '".$foto10."', '".$UrlYT."', '".$condividiveicolo."', '".$PrezzoConcessionari."')";

...
if(tiporic=="1") {
	query =" idCarrozzeria=1";
}
else if(tiporic=="2") {
	query =" idCarrozzeria=2";
}
else if(tiporic=="3") {
	query =" idCarrozzeria=3";
}
else if(tiporic=="4") {
	query =" idCarrozzeria=4";
}
else if(tiporic=="5") {
	query =" idCarrozzeria=5";
}
else if(tiporic=="6") {
	query =" idCarrozzeria=6";
}
else if(tiporic=="7") {
	query =" idCarrozzeria=7";
}
else if(tiporic=="7") {
	query =" idCarrozzeria=7";
}
...
function Elenco(query, start, limit, tipoRic, page, ordine){
	...
	//alert(query+ start+ limit+ tipoRic+ page+ ordine);
	$.ajax({
		type: "POST",
				...
				<div class="widget-container widget_adv_filter">
					...
					<form action="ricerca.php" class="side_form " onsubmit="return validation();">
						...
						<div class="row input_styled checklist" style="padding-bottom:20px;">
							<label class="label_title">Chilometri:</label>

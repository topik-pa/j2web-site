			...
			<div class="content">            
				...
				<div class="entry">
	                ...
	                <div class="row clearfix">
						...
						<form id="ins" name="ins" action="valinsp.php" method="POST" onsubmit="return control();" enctype="multipart/form-data">
							...
							<div class="col col_1_3 omega">
								<ul class="">
									...
									<li><input type="text" class="" id="UrlYT" name="UrlYT" placeholder="Url YouTube"/><a onclick="alert('Andare in \'Condividi\' e selzionare il link della sezione \'Condividi questo video\'');"><img src="images/icons/icon_info.png" style="margin-left:5px; width:auto;" id="info"/></a></li>
